...
```{r fig.cap = "Extremely complicated decision boundary", out.width='100%', fig.align='center', echo=FALSE, fig.show = "keep"}
...
```{r fig.cap = "Simple decision boundary", out.width='100%', fig.align='center', echo=FALSE, fig.show = "keep"}
