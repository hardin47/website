...
```{r fig.cap = "xkcd, https://xkcd.com/1481/", out.width='80%', fig.align="right",  echo=FALSE}
...
```{r fig.cap="Image taken from https://rigor.com/blog/what-is-an-api-a-brief-intro", out.width='80%', fig.align="right",  echo=FALSE}
