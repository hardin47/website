...
```{r fig.width=15, fig.align="center",  echo=FALSE, fig.cap = "From Hesterberg et al., Chapter 16 of Introduction to the Practice of Statistics by  Moore, McCabe, and Craig"}
img3 <- readPNG("figs/BSlogic.png")
 grid.raster(img3)
```
...
```{r fig.width=15, fig.align="center",  echo=FALSE, fig.cap = "From Hesterberg et al., Chapter 16 of Introduction to the Practice of Statistics by  Moore, McCabe, and Craig"}
img4 <- readPNG("figs/BShesterberg1.png")
img5 <- readPNG("figs/BShesterberg2.png")
img6 <- readPNG("figs/BShesterberg3.png")
 grid.raster(img4)
 grid.raster(img5)
 grid.raster(img6)
```
