...
```{r fig.cap = "Reproduction of a data graphic reporting the number of gun deaths in Florida over time. The original image was published by Reuters.  [@MDSR]", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "A tweet by *National Review* on December 14, 2015 showing the change in global temperature over time.  [@MDSR]", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "Not only is it worth discussing the ethics of how the data were collected, but it also seems like maybe the study did some p-hacking.", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "The paper was retracted because the authors could not agree on the order of authorship.", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "Dylan Fugett had three subsequent arrests for drug possession.  Bernard Parker had no subsequent offenses.", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "False positive and false negative rates broken down by race.", fig.width = 7, fig.align='center', echo=FALSE}
