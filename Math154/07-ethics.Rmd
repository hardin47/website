...
```{r fig.cap = "May 10, 2020, Georgia Department of Health, COVID-19 cases for 5 counties across time. https://dph.georgia.gov/covid-19-daily-status-report", out.width='100%', fig.align='center', echo=FALSE}
knitr::include_graphics("figs/GAcovid.jpg")
```

```{r fig.cap = "May 17, 2020, Georgia Department of Health, COVID-19 cases for 5 counties across time, corrected with time chronological. https://dph.georgia.gov/covid-19-daily-status-report", out.width='100%', fig.align='center', echo=FALSE}
