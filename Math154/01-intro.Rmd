...
```{r fig.cap = "Probability vs. Statistics", fig.width = 7, fig.align='center'}
...
```{r fig.cap = "Taken from [Modern Drive: An introduction to statistical and data sciences via R](https://ismayc.github.io/moderndiver-book/), by Ismay and Kim", fig.width = 7, fig.align='center'}
knitr::include_graphics("figs/RRstudio.jpg")
```

```{r fig.cap = "[Jessica Ward](https://jkrward.github.io/), PhD student at Newcastle University", fig.width = 7, fig.align='center'}
...
```{r fig.cap = "A schematic of the typical workflow used in data analysis.  Most statistics classes focus only on the left side.  We will work to address all aspects (including those on the right side). [@Baumer15]", fig.width = 7, fig.align='center'}
knitr::include_graphics("figs/AnalysisProcessBaumer.jpg")
```


```{r fig.cap = "[Stitch Fix Algorithms Tour](http://algorithms-tour.stitchfix.com/)", fig.width = 7, fig.align='center'}
