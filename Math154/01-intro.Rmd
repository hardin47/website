...
```{r fig.cap = "Probability vs. Statistics", fig.width = 7, fig.align='center', echo=FALSE}
...
```{r fig.cap = "[Jessica Ward](https://jkrward.github.io/), PhD student at Newcastle University", fig.width = 7, fig.align='center', echo=FALSE}
