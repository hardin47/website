...
```{r fig.cap = "From the  Kent County COVID dashboard, screen shot 8/25/2021.  https://www.accesskent.com/Health/covid-19-data.htm", out.width='90%', fig.align='center', echo=FALSE, fig.alt = "Screen shot of the Kent, MI COVID dashboard.  There are clearly three peaks over the last year and a half (Dec 2021, April 2021, and August 2021).  The peaked data should not be modeled with a linear trend."}
...
https://www.oreilly.com/content/how-we-amplify-privilege-with-supervised-machine-learning/
