...
```{r echo = FALSE, out.width = "80%", fig.cap = "Power as a function of mu.  Top plot describes the delta1 test; middle plot describes the delta2 test; bottom plot describes the delta3 (two-sided!) test."}
