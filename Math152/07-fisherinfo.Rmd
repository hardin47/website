...
```{r echo = FALSE}
theta = seq(1,40, by = 0.1)

ex = 2
plot(theta, (1/theta)*exp(-ex/theta), type = "l", ylab="likelihood, X=2")
abline(v=ex)

ex = 5
plot(theta, (1/theta)*exp(-ex/theta), type = "l", ylab="likelihood, X=5")
abline(v=ex)

ex = 10
plot(theta, (1/theta)*exp(-ex/theta), type = "l", ylab="likelihood, X=10")
abline(v=ex)
```
...
```{r echo = FALSE, out.width = "80%", fig.cap = "David Blackwell. Image credit: https://math.illinois.edu/david-blackwell"}
knitr::include_graphics("figs/blackwell.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.cap = "C.R. Rao. Image credit: https://pib.gov.in/PressReleseDetail.aspx?PRID=1653064"}
knitr::include_graphics("figs/rao.jpeg")
```
