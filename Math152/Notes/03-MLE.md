...
$$\prod_{i=1}^n [1 + (x_i - \theta)^2]^{-1}$$
   ...
   b.  Consider trying to find the root of a function f(x). Suppose your current
guess is some value $x_0$. We might approximate the function by the tangent line (first order Taylor approximation) at x0 and take our next guess as the root of that line. Use the Taylor expansion to find the next guess of $x_1$ as

$$x_1 = x_0 - \frac{f(x_0)}{f'(x_0)}$$

Continually updating our guesses via this method is known as Newton's Method
...
```r
x=rt(50,1)+10  # 50 random Cauchy variables centered at 10
