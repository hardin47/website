...
\rightarrow \mbox{Then: } \beta(\delta^*) \leq \beta(\delta)&  \& & \beta(\delta^*) < \beta(\delta) \\
\end{eqnarray*}
...
<div class="figure">
<img src="figs/power.png" alt="Power as a function of mu.  Top plot describes the delta1 test; middle plot describes the delta2 test; bottom plot describes the delta3 (two-sided!) test." width="80%" />
<p class="caption">(\#fig:unnamed-chunk-1)Power as a function of mu.  Top plot describes the delta1 test; middle plot describes the delta2 test; bottom plot describes the delta3 (two-sided!) test.</p>
</div>
...
\begin{enumerate}
\item
$\pi(\mu,\sigma^2 | \delta) = \alpha_0 \ \ \ \ \ \ \ \mu=\mu_0$
\item
$\pi(\mu,\sigma^2 | \delta) < \alpha_0 \ \ \ \ \ \ \ \mu>\mu_0$
\item
$\pi(\mu,\sigma^2 | \delta) > \alpha_0 \ \ \ \ \ \ \ \mu<\mu_0$
\item
$\pi(\mu,\sigma^2 | \delta) \rightarrow 0 \ \ \ \ \ \ \ \mu \rightarrow \infty$
\item
$\pi(\mu,\sigma^2 | \delta) \rightarrow 1 \ \ \ \ \ \ \ \mu \rightarrow -\infty$
\end{enumerate}
...
5. What is the difference between size, level of significance, and power?
6. What does it mean for a result to be "significant"?
...
1. Which is worse, type I or type II errors?
...
3. Is the p-value the probability that the null hypothesis is true?  Explain.
