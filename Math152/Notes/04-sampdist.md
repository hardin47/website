...
## 1 136.60     127      141  155.10         145     167.4444    10  147
## 2 153.62     167      146  147.46         147     147.9293   100  147
## 3 552.00     596      445  489.50         461     524.3333    10  447
## 4 448.58     444      443  447.43         455     439.7071   100  447
## 5 171.80     176      141  155.10         152     158.8889    10  147
## 6 141.06     138      147  148.47         149     147.9293   100  147
## 7 541.00     580      426  468.60         529     394.7778    10  447
## 8 447.80     422      446  450.46         454     446.8485   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            132.
##  2    10   147 median2          131 
##  3    10   147 samp.max         130 
##  4    10   147 mod.max          143 
##  5    10   147 sum.min.max      132 
...
##  1    10   147 diff.min.max  148.   152.   1.38    344.   346.
##  2    10   147 median2       146.   146   -1.41   1424.  1426.
##  3    10   147 mod.max       148.   152.   1.20    155.   157.
##  4    10   147 samp.max      135.   138  -12.3     128.   279.
##  5    10   147 sum.min.max   148.   148    1.05    277.   278.
##  6    10   147 xbar2         147.   147.  -0.382   599.   599.
##  7    10   447 diff.min.max  445.   458.  -1.87   3839.  3843.
##  8    10   447 median2       449.   450.   1.84  14795. 14798.
##  9    10   447 mod.max       448.   460.   1.42   1587.  1589.
## 10    10   447 samp.max      408.   418  -39.3    1311.  2859.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
