...
## 1 177.40     225      147  161.70         149     177.2222    10  147
## 2 145.68     150      146  147.46         147     147.9293   100  147
## 3 538.20     582      445  489.50         579     380.1111    10  447
## 4 422.00     420      447  451.47         451     451.9495   100  447
## 5 147.80     184      123  135.30         133     138.1111    10  147
## 6 148.36     148      146  147.46         147     147.9293   100  147
## 7 611.80     701      437  480.70         545     402.1111    10  447
## 8 437.74     457      447  451.47         452     450.9293   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            153.
##  2    10   147 median2          190 
##  3    10   147 samp.max         147 
##  4    10   147 mod.max          162.
##  5    10   147 sum.min.max      156 
##  6    10   147 diff.min.max     169.
##  7   100   147 xbar2            152.
...
##  1    10   147 diff.min.max  148.   150.   0.803   342.   342.
##  2    10   147 median2       146.   146   -0.872  1560.  1561.
##  3    10   147 mod.max       147.   151.   0.476   169.   169.
##  4    10   147 samp.max      134.   137  -12.9     139.   307.
##  5    10   147 sum.min.max   147.   148    0.208   304.   305.
##  6    10   147 xbar2         146.   146.  -0.79    677.   677.
##  7    10   447 diff.min.max  448.   461.   0.738  3715.  3716.
##  8    10   447 median2       445.   446.  -1.87  14988. 14991.
##  9    10   447 mod.max       446.   459.  -0.765  1838.  1838.
## 10    10   447 samp.max      406.   417  -41.3    1519.  3227.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
