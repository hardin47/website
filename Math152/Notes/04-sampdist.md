...
## 1 141.80     110      142  156.20         144     171.1111    10  147
## 2 137.30     133      144  145.44         145     145.8889   100  147
## 3 379.80     413      427  469.70         428     520.6667    10  447
## 4 453.50     461      441  445.41         442     448.8889   100  447
## 5 200.00     214      138  151.80         195      99.0000    10  147
## 6 145.86     142      147  148.47         152     144.8687   100  147
## 7 450.00     501      375  412.50         439     380.1111    10  447
## 8 459.68     442      447  451.47         448     455.0101   100  447
```
...
##  5    10   147 sum.min.max      152 
##  6    10   147 diff.min.max     166.
##  7   100   147 xbar2            149.
...
##  1    10   147 diff.min.max  147.   150.   0.239   370.   370.
##  2    10   147 median2       147.   148   -0.056  1475.  1475.
##  3    10   147 mod.max       148.   152.   0.895   170.   171.
##  4    10   147 samp.max      134.   138  -12.6     140.   298.
##  5    10   147 sum.min.max   148.   149    1.43    288.   290.
##  6    10   147 xbar2         147.   148    0.316   645.   645.
##  7    10   447 diff.min.max  446.   457.  -1.21   3952.  3953.
##  8    10   447 median2       445.   445   -2.16  15046. 15050.
##  9    10   447 mod.max       446.   458.  -1.38   1823.  1825.
## 10    10   447 samp.max      405.   416  -41.9    1507.  3261.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
