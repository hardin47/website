...
## 1 155.40     156      132  145.20         134     158.8889    10  147
## 2 153.94     162      147  148.47         148     148.9495   100  147
## 3 380.00     345      376  413.60         378     457.1111    10  447
## 4 444.24     476      437  441.37         438     444.8081   100  447
## 5 167.20     171      135  148.50         147     150.3333    10  147
## 6 149.52     154      147  148.47         150     146.9091   100  147
## 7 513.40     625      434  477.40         439     524.3333    10  447
## 8 437.44     446      447  451.47         449     453.9899   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            149 
##  2    10   147 median2          128 
##  3    10   147 samp.max         136 
##  4    10   147 mod.max          150.
##  5    10   147 sum.min.max      163 
##  6    10   147 diff.min.max     133.
##  7   100   147 xbar2            143.
##  8   100   147 median2          141 
...
##  1    10   147 diff.min.max  147.   152.   0.454   426.   427.
##  2    10   147 median2       146.   148.  -0.648  1548.  1548.
##  3    10   147 mod.max       147.   152.   0.496   180.   181.
##  4    10   147 samp.max      134.   138  -12.9     149.   316.
##  5    10   147 sum.min.max   148.   148    0.53    312.   312.
##  6    10   147 xbar2         146.   147.  -0.691   670.   670.
##  7    10   447 diff.min.max  448.   459.   1.42   3829.  3831.
##  8    10   447 median2       451.   455    3.88  14042. 14057.
##  9    10   447 mod.max       449.   460.   1.99   1481.  1485.
## 10    10   447 samp.max      408.   418  -38.8    1224.  2732.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
