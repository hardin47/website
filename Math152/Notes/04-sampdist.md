...
## 1 165.60     193      129  141.90         137     147.8889    10  147
## 2 150.82     152      145  146.45         146     146.9091   100  147
## 3 407.40     340      385  423.50         407     443.6667    10  447
## 4 441.76     431      442  446.42         443     449.9091   100  447
## 5 137.40     151      132  145.20         144     146.6667    10  147
## 6 143.38     146      146  147.46         147     147.9293   100  147
## 7 349.20     367      354  389.40         356     430.2222    10  447
## 8 435.94     417      447  451.47         454     448.8889   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            125.
##  2    10   147 median2          147 
##  3    10   147 samp.max         119 
##  4    10   147 mod.max          131.
##  5    10   147 sum.min.max      120 
##  6    10   147 diff.min.max     144.
##  7   100   147 xbar2            148.
...
##  1    10   147 diff.min.max  148.   150.   0.860   359.   359.
##  2    10   147 median2       148.   149    0.802  1482.  1482.
##  3    10   147 mod.max       148.   152.   1.14    172.   173.
##  4    10   147 samp.max      135.   138  -12.3     142.   294.
##  5    10   147 sum.min.max   148.   148    1.37    328.   330.
##  6    10   147 xbar2         148.   148    0.957   658.   659.
##  7    10   447 diff.min.max  447.   458.   0.133  3737.  3737.
##  8    10   447 median2       445.   443   -2.49  14722. 14728.
##  9    10   447 mod.max       446.   461.  -0.646  1761.  1762.
## 10    10   447 samp.max      406.   419  -41.2    1456.  3155.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
