...
## 1 158.80     174      138  151.80         141     165.0000    10  147
## 2 144.52     153      147  148.47         148     148.9495   100  147
## 3 283.60     239      388  426.80         418     437.5556    10  447
## 4 440.28     460      447  451.47         456     446.8485   100  447
## 5 108.60      92      146  160.60         147     177.2222    10  147
## 6 141.68     140      147  148.47         148     148.9495   100  147
## 7 441.40     401      429  471.90         468     476.6667    10  447
## 8 429.48     418      443  447.43         444     450.9293   100  447
```
...
##  6    10   147 diff.min.max     130.
##  7   100   147 xbar2            144.
##  8   100   147 median2          136 
...
##  1    10   147 diff.min.max  148.   152.   0.932   351.   352.
##  2    10   147 median2       147.   148    0.375  1563.  1563.
##  3    10   147 mod.max       148.   152.   1.36    165.   167.
##  4    10   147 samp.max      135.   138  -12.1     136.   283.
##  5    10   147 sum.min.max   149.   149    1.72    310.   313.
##  6    10   147 xbar2         147.   148.   0.184   706.   706.
##  7    10   447 diff.min.max  448.   458.   0.591  3660.  3660.
##  8    10   447 median2       446.   444   -0.653 14195. 14195.
##  9    10   447 mod.max       447.   459.  -0.185  1712.  1712.
## 10    10   447 samp.max      406.   417  -40.8    1415.  3080.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
