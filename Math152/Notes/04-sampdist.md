...
## 1 120.00     105      126  138.60         129     150.3333    10  147
## 2 140.88     138      146  147.46         147     147.9293   100  147
## 3 562.20     671      426  468.60         438     506.0000    10  447
## 4 434.90     427      446  450.46         457     443.7879   100  447
## 5 150.80     139      146  160.60         152     171.1111    10  147
## 6 149.56     150      147  148.47         148     148.9495   100  147
## 7 373.40     364      404  444.40         435     455.8889    10  447
## 8 449.18     423      445  449.45         449     449.9091   100  447
```
...
##  1    10   147 xbar2            99.4
##  2    10   147 median2          82  
##  3    10   147 samp.max        128  
##  4    10   147 mod.max         141. 
##  5    10   147 sum.min.max     139  
...
##  1    10   147 diff.min.max  147.   150.   0.0712   421.   421.
##  2    10   147 median2       148.   148    1.18    1516.  1517.
##  3    10   147 mod.max       148.   152.   0.521    185.   186.
##  4    10   147 samp.max      134.   138  -12.9      153.   319.
##  5    10   147 sum.min.max   148.   148    0.889    325.   326.
##  6    10   147 xbar2         147.   146.   0.314    690.   690.
##  7    10   447 diff.min.max  446.   456.  -0.809   3434.  3435.
##  8    10   447 median2       452.   450    5.13   15369. 15395.
##  9    10   447 mod.max       450.   462    2.70    1503.  1511.
## 10    10   447 samp.max      409.   420  -38.2     1242.  2700.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
