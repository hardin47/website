...
## 1 143.20     162      115  126.50         125     128.3333    10  147
## 2 153.60     153      147  148.47         149     147.9293   100  147
## 3 483.00     484      367  403.70         387     424.1111    10  447
## 4 444.30     442      447  451.47         459     443.7879   100  447
## 5 104.40      87      129  141.90         130     156.4444    10  147
## 6 143.96     143      146  147.46         147     147.9293   100  147
## 7 370.80     377      315  346.50         383     301.8889    10  447
## 8 421.34     432      446  450.46         447     453.9899   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            130 
##  2    10   147 median2          132 
##  3    10   147 samp.max         124 
##  4    10   147 mod.max          136.
##  5    10   147 sum.min.max      131 
##  6    10   147 diff.min.max     143 
##  7   100   147 xbar2            155.
##  8   100   147 median2          157 
...
##  1    10   147 diff.min.max  149.   152.   1.55    348.   350.
##  2    10   147 median2       147.   146    0.211  1570.  1570.
##  3    10   147 mod.max       148.   152.   1.38    165.   167.
##  4    10   147 samp.max      135.   138  -12.1     136.   283.
##  5    10   147 sum.min.max   148.   148    1.25    320.   322.
##  6    10   147 xbar2         147.   147.   0.494   712.   713.
##  7    10   447 diff.min.max  450.   461.   2.77   3558.  3566.
##  8    10   447 median2       449.   448.   2.36  15470. 15475.
##  9    10   447 mod.max       448.   460.   0.834  1695.  1696.
## 10    10   447 samp.max      407.   418  -39.9    1401.  2991.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
