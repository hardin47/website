...
## 1 142.20     127      144  158.40         153     165.0000    10  147
## 2 141.22     138      147  148.47         148     148.9495   100  147
## 3 590.40     612      412  453.20         567     314.1111    10  447
## 4 428.64     414      444  448.44         453     443.7879   100  447
## 5 198.60     224      145  159.50         163     155.2222    10  147
## 6 147.60     145      146  147.46         151     143.8485   100  147
## 7 486.40     491      405  445.50         492     388.6667    10  447
## 8 429.02     415      446  450.46         448     452.9697   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            145.
##  2    10   147 median2          159 
##  3    10   147 samp.max         123 
##  4    10   147 mod.max          135.
##  5    10   147 sum.min.max      124 
##  6    10   147 diff.min.max     149.
##  7   100   147 xbar2            147.
##  8   100   147 median2          147 
...
##  1    10   147 diff.min.max  148.   152.   0.548   353.   353.
##  2    10   147 median2       145.   146   -1.61   1499.  1502.
##  3    10   147 mod.max       147.   151.   0.498   170.   170.
##  4    10   147 samp.max      134.   137  -12.9     140.   307.
##  5    10   147 sum.min.max   147.   148    0.457   296.   296.
##  6    10   147 xbar2         146    147.  -1       671.   672.
##  7    10   447 diff.min.max  450.   460.   3.37   3307.  3318.
##  8    10   447 median2       445.   450   -2.17  14999. 15003.
##  9    10   447 mod.max       448.   460.   0.734  1681.  1681.
## 10    10   447 samp.max      407.   418  -40.0    1389.  2986.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
