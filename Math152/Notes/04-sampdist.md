...
## 1 152.40     157      137  150.70         154     146.6667    10  147
## 2 154.80     159      147  148.47         148     148.9495   100  147
## 3 453.20     454      428  470.80         437     512.1111    10  447
## 4 417.10     358      447  451.47         449     453.9899   100  447
## 5 149.00     115      141  155.10         159     150.3333    10  147
## 6 143.28     138      147  148.47         148     148.9495   100  147
## 7 373.60     279      400  440.00         451     426.5556    10  447
## 8 425.22     434      446  450.46         447     453.9899   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            128.
##  2    10   147 median2          104 
##  3    10   147 samp.max         127 
##  4    10   147 mod.max          140.
##  5    10   147 sum.min.max      129 
##  6    10   147 diff.min.max     153.
##  7   100   147 xbar2            149.
##  8   100   147 median2          151 
...
##  1    10   147 diff.min.max  148.   152.   1.17     375.   376.
##  2    10   147 median2       148.   146    1.21    1712.  1713.
##  3    10   147 mod.max       148.   152.   1.02     175.   176.
##  4    10   147 samp.max      135.   138  -12.4      145.   299.
##  5    10   147 sum.min.max   148.   148    0.888    328.   329.
##  6    10   147 xbar2         147.   147.   0.0318   745.   745.
##  7    10   447 diff.min.max  451.   461.   3.72    3436.  3449.
##  8    10   447 median2       445.   442.  -1.58   14480. 14483.
##  9    10   447 mod.max       448.   459.   1.42    1487.  1489.
## 10    10   447 samp.max      408.   417  -39.4     1229.  2777.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
