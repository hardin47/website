...
## 1  94.40      87       94  103.40         107      99.0000    10  147
## 2 134.16     130      146  147.46         147     147.9293   100  147
## 3 394.40     369      441  485.10         460     515.7778    10  447
## 4 439.18     430      447  451.47         449     453.9899   100  447
## 5 163.60     167      133  146.30         144     149.1111    10  147
## 6 143.94     148      147  148.47         148     148.9495   100  147
## 7 554.60     566      431  474.10         434     523.1111    10  447
## 8 463.86     483      438  442.38         441     443.7879   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            146.
##  2    10   147 median2          126 
##  3    10   147 samp.max         132 
##  4    10   147 mod.max          145.
##  5    10   147 sum.min.max      154 
##  6    10   147 diff.min.max     134.
##  7   100   147 xbar2            144.
...
##  1    10   147 diff.min.max  147.   150.  -0.174   388.   388.
##  2    10   147 median2       149.   149    1.81   1483.  1487.
##  3    10   147 mod.max       147.   152.   0.476   182.   182.
##  4    10   147 samp.max      134.   138  -12.9     150.   317.
##  5    10   147 sum.min.max   148.   148    1.01    339.   340.
##  6    10   147 xbar2         148.   148    1.06    663.   664.
##  7    10   447 diff.min.max  446.   453.  -1.07   3215.  3216.
##  8    10   447 median2       439.   438   -7.81  14425. 14486.
##  9    10   447 mod.max       445.   455.  -1.89   1675.  1679.
## 10    10   447 samp.max      405.   414  -42.4    1384.  3178.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
