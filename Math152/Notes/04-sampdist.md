...
## 1 147.80     132      147  161.70         153     172.3333    10  147
## 2 139.68     141      146  147.46         147     147.9293   100  147
## 3 293.80     286      241  265.10         276     251.7778    10  447
## 4 416.10     377      445  449.45         448     450.9293   100  447
## 5 175.00     160      145  159.50         172     144.2222    10  147
## 6 149.30     158      145  146.45         147     145.8889   100  147
## 7 439.00     387      377  414.70         469     348.3333    10  447
## 8 460.06     489      446  450.46         450     450.9293   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            102 
##  2    10   147 median2          108 
##  3    10   147 samp.max          93 
##  4    10   147 mod.max          102.
##  5    10   147 sum.min.max      100 
##  6    10   147 diff.min.max     105.
##  7   100   147 xbar2            145.
##  8   100   147 median2          148 
...
##  1    10   147 diff.min.max  148.   152.   1.00    371.   372.
##  2    10   147 median2       148.   148.   1.19   1605.  1606.
##  3    10   147 mod.max       148.   152.   0.951   177.   178.
##  4    10   147 samp.max      135.   138  -12.5     146.   303.
##  5    10   147 sum.min.max   148.   148    0.909   305.   306.
##  6    10   147 xbar2         148.   148    0.788   690.   690.
##  7    10   447 diff.min.max  449.   463.   1.89   3844.  3847.
##  8    10   447 median2       448.   447    1.33  15179. 15181.
##  9    10   447 mod.max       447.   461.   0.158  1903.  1903.
## 10    10   447 samp.max      407.   419  -40.5    1573.  3213.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
