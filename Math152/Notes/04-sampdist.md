...
## 1 119.20     104      126  138.60         129     150.3333    10  147
## 2 146.22     142      147  148.47         148     148.9495   100  147
## 3 406.60     405      364  400.40         372     435.1111    10  447
## 4 453.26     433      446  450.46         449     451.9495   100  447
## 5 159.80     150      139  152.90         160     144.2222    10  147
## 6 148.44     152      145  146.45         146     146.9091   100  147
## 7 412.00     383      393  432.30         452     408.2222    10  447
## 8 445.46     454      446  450.46         447     453.9899   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            141.
##  2    10   147 median2          115 
##  3    10   147 samp.max         126 
##  4    10   147 mod.max          139.
##  5    10   147 sum.min.max      135 
...
##  1    10   147 diff.min.max  147.   150.   0.278   385.   385.
##  2    10   147 median2       147.   148   -0.383  1538.  1539.
##  3    10   147 mod.max       148.   152.   0.695   168.   169.
##  4    10   147 samp.max      134.   138  -12.7     139.   301.
##  5    10   147 sum.min.max   148.   148    1.04    305.   306.
##  6    10   147 xbar2         147.   146.   0.182   689.   689.
##  7    10   447 diff.min.max  447.   456.   0.427  3571.  3571.
##  8    10   447 median2       442.   446   -5.04  15268. 15294.
##  9    10   447 mod.max       448.   461.   1.06   1666.  1667.
## 10    10   447 samp.max      407.   419  -39.7    1377.  2951.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
