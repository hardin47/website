...
## 1 148.20     171      130  143.00         132     156.4444    10  147
## 2 145.14     144      147  148.47         148     148.9495   100  147
## 3 500.80     543      392  431.20         480     371.5556    10  447
## 4 503.36     520      444  448.44         447     449.9091   100  447
## 5 104.40      71      112  123.20         122     124.6667    10  147
## 6 141.36     135      146  147.46         147     147.9293   100  147
## 7 419.60     331      422  464.20         439     495.0000    10  447
## 8 400.30     356      442  446.42         444     448.8889   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            145.
##  2    10   147 median2          143 
##  3    10   147 samp.max         134 
##  4    10   147 mod.max          147.
##  5    10   147 sum.min.max      140 
##  6    10   147 diff.min.max     156.
##  7   100   147 xbar2            139.
##  8   100   147 median2          132 
...
##  1    10   147 diff.min.max  148.   150.   0.677   364.   364.
##  2    10   147 median2       144.   142   -2.63   1588.  1595.
##  3    10   147 mod.max       148.   152.   0.719   176.   177.
##  4    10   147 samp.max      134.   138  -12.7     145.   307.
##  5    10   147 sum.min.max   148.   148    0.753   317.   318.
##  6    10   147 xbar2         145.   145   -1.80    684.   687.
##  7    10   447 diff.min.max  449.   460.   2.42   3528.  3534.
##  8    10   447 median2       447.   444   -0.019 14013. 14013.
##  9    10   447 mod.max       447.   459.  -0.487  1768.  1769.
## 10    10   447 samp.max      406.   417  -41.1    1462.  3149.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
