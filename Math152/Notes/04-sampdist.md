...
## 1 169.60     166      145  159.50         179     135.6667    10  147
## 2 146.76     145      146  147.46         147     147.9293   100  147
## 3 348.60     310      431  474.10         437     519.4444    10  447
## 4 480.20     518      445  449.45         449     449.9091   100  447
## 5 147.40     130      145  159.50         171     145.4444    10  147
## 6 141.48     141      147  148.47         148     148.9495   100  147
## 7 457.60     511      425  467.50         454     484.0000    10  447
## 8 460.92     488      439  443.39         442     444.8081   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            159.
##  2    10   147 median2          183 
##  3    10   147 samp.max         138 
##  4    10   147 mod.max          152.
##  5    10   147 sum.min.max      157 
##  6    10   147 diff.min.max     145.
##  7   100   147 xbar2            139.
##  8   100   147 median2          133 
...
##  1    10   147 diff.min.max  148.   152.   0.993   372.   373.
##  2    10   147 median2       146.   148   -0.726  1585.  1586.
##  3    10   147 mod.max       148.   152.   0.750   180.   180.
##  4    10   147 samp.max      134.   138  -12.7     148.   309.
##  5    10   147 sum.min.max   148.   148    0.551   325.   325.
##  6    10   147 xbar2         147.   147.  -0.180   684.   684.
##  7    10   447 diff.min.max  450.   460.   2.66   3715.  3722.
##  8    10   447 median2       446.   450.  -0.595 14493. 14494.
##  9    10   447 mod.max       448.   458.   0.712  1651.  1652.
## 10    10   447 samp.max      407.   416  -40.0    1365.  2964.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
