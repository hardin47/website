...
## 1 121.40     128      123  135.30         136     134.4444    10  147
## 2 145.88     142      147  148.47         149     147.9293   100  147
## 3 615.20     722      429  471.90         518     415.5556    10  447
## 4 407.30     397      446  450.46         447     453.9899   100  447
## 5 203.40     245      139  152.90         156     149.1111    10  147
## 6 153.54     152      147  148.47         149     147.9293   100  147
## 7 476.60     512      432  475.20         461     492.5556    10  447
## 8 446.52     428      446  450.46         451     449.9091   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            128 
##  2    10   147 median2          121 
##  3    10   147 samp.max         144 
##  4    10   147 mod.max          158.
##  5    10   147 sum.min.max      149 
##  6    10   147 diff.min.max     170.
##  7   100   147 xbar2            142.
##  8   100   147 median2          143 
##  9   100   147 samp.max         145 
## 10   100   147 mod.max          146.
...
##  1    10   147 diff.min.max  148.   152.   0.941   383.   384.
##  2    10   147 median2       147.   147    0.392  1559.  1559.
##  3    10   147 mod.max       148.   152.   1.04    167.   168.
##  4    10   147 samp.max      135.   138  -12.4     138.   292.
##  5    10   147 sum.min.max   148.   148    1.12    295.   296.
##  6    10   147 xbar2         147.   147.   0.366   674.   675.
##  7    10   447 diff.min.max  449.   458.   1.99   3686.  3690.
##  8    10   447 median2       453.   448    5.80  15342. 15376.
##  9    10   447 mod.max       448.   460.   1.15   1727.  1728.
## 10    10   447 samp.max      407.   418  -39.6    1427.  2995.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
