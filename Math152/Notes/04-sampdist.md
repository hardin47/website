...
## 1 132.00     157      147  161.70         153     172.3333    10  147
## 2 147.28     147      147  148.47         148     148.9495   100  147
## 3 533.20     613      435  478.50         516     432.6667    10  447
## 4 465.76     476      436  440.36         441     439.7071   100  447
## 5 172.00     172      132  145.20         145     145.4444    10  147
## 6 137.60     136      146  147.46         147     147.9293   100  147
## 7 502.80     568      421  463.10         445     485.2222    10  447
## 8 404.74     400      443  447.43         448     446.8485   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            173.
##  2    10   147 median2          188 
##  3    10   147 samp.max         125 
##  4    10   147 mod.max          138.
##  5    10   147 sum.min.max      154 
##  6    10   147 diff.min.max     117.
##  7   100   147 xbar2            142.
##  8   100   147 median2          140 
...
##  1    10   147 diff.min.max  147.   150.  -0.361    385.   385.
##  2    10   147 median2       147.   147   -0.194   1595.  1595.
##  3    10   147 mod.max       148.   151.   0.567    173.   173.
##  4    10   147 samp.max      134.   137  -12.8      143.   308.
##  5    10   147 sum.min.max   148.   148    1.33     342.   344.
##  6    10   147 xbar2         147.   147.   0.244    730.   730.
##  7    10   447 diff.min.max  447.   460.   0.0192  3569.  3569.
##  8    10   447 median2       444.   446   -2.82   15458. 15466.
##  9    10   447 mod.max       448.   461.   1.12    1654.  1655.
## 10    10   447 samp.max      407.   419  -39.6     1367.  2937.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
