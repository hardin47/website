...
## 1  97.60      53      120  132.00         121     145.4444    10  147
## 2 151.44     154      146  147.46         150     144.8687   100  147
## 3 524.80     526      424  466.40         499     426.5556    10  447
## 4 390.58     388      445  449.45         446     452.9697   100  447
## 5 150.80     128      146  160.60         166     154.0000    10  147
## 6 147.10     144      145  146.45         146     146.9091   100  147
## 7 501.80     548      364  400.40         441     350.7778    10  447
## 8 492.18     503      446  450.46         460     440.7273   100  447
```
...
##  5    10   147 sum.min.max      143 
##  6    10   147 diff.min.max     153.
##  7   100   147 xbar2            151.
##  8   100   147 median2          156 
...
##  1    10   147 diff.min.max  148.   152.   1.23    391.   393.
##  2    10   147 median2       148.   148.   0.868  1578.  1579.
##  3    10   147 mod.max       148.   152.   1.20    167.   169.
##  4    10   147 samp.max      135.   138  -12.3     138.   289.
##  5    10   147 sum.min.max   148.   148    1.17    315.   316.
##  6    10   147 xbar2         148.   148.   0.754   700.   701.
##  7    10   447 diff.min.max  448.   456.   0.735  3590.  3590.
##  8    10   447 median2       443.   441   -3.82  15843. 15858.
##  9    10   447 mod.max       448.   461.   1.29   1705.  1706.
## 10    10   447 samp.max      408.   419  -39.5    1409.  2966.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
