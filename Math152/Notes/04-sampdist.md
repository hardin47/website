...
## 1 103.40      77      134  147.40         135     162.5556    10  147
## 2 149.12     153      147  148.47         148     148.9495   100  147
## 3 533.00     586      421  463.10         436     496.2222    10  447
## 4 464.08     490      445  449.45         446     452.9697   100  447
## 5 187.40     176      140  154.00         198     100.2222    10  147
## 6 143.66     146      146  147.46         148     146.9091   100  147
## 7 431.00     385      351  386.10         398     371.5556    10  447
## 8 443.28     400      447  451.47         450     452.9697   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            132.
##  2    10   147 median2          112 
##  3    10   147 samp.max         138 
##  4    10   147 mod.max          152.
##  5    10   147 sum.min.max      141 
...
##  1    10   147 diff.min.max  149.   153.   2.35   329.   334.
##  2    10   147 median2       149.   149    1.78  1482.  1485.
##  3    10   147 mod.max       149.   152.   2.33   130.   135.
##  4    10   147 samp.max      136.   138  -11.2    107.   234.
##  5    10   147 sum.min.max   149.   148    2.32   291.   297.
##  6    10   147 xbar2         149.   149.   1.67   644.   646.
##  7    10   447 diff.min.max  442.   455.  -5.06  3890.  3915.
##  8    10   447 median2       444.   448.  -2.66 15264. 15271.
##  9    10   447 mod.max       445.   458.  -2.09  1876.  1881.
## 10    10   447 samp.max      404.   416  -42.5   1551.  3360.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
