...
## 1 158.00     169      144  158.40         147     172.3333    10  147
## 2 147.40     150      146  147.46         148     146.9091   100  147
## 3 594.20     661      398  437.80         574     271.3333    10  447
## 4 436.82     453      438  442.38         441     443.7879   100  447
## 5 184.20     176      146  160.60         181     135.6667    10  147
## 6 146.74     146      146  147.46         147     147.9293   100  147
## 7 421.00     340      410  451.00         451     451.0000    10  447
## 8 462.62     469      443  447.43         446     448.8889   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            134.
##  2    10   147 median2          107 
##  3    10   147 samp.max         136 
##  4    10   147 mod.max          150.
##  5    10   147 sum.min.max      153 
##  6    10   147 diff.min.max     145.
##  7   100   147 xbar2            145.
##  8   100   147 median2          142 
...
##  1    10   147 diff.min.max  148.   152.   1.27    364.   365.
##  2    10   147 median2       148.   147    1.12   1595.  1596.
##  3    10   147 mod.max       149.   153.   1.57    154.   156.
##  4    10   147 samp.max      135.   139  -11.9     127.   270.
##  5    10   147 sum.min.max   149.   148    1.82    309.   312.
##  6    10   147 xbar2         148.   148.   0.838   689.   690.
##  7    10   447 diff.min.max  447.   457.  -0.237  3674.  3674.
##  8    10   447 median2       453.   453    6.46  14447. 14489.
##  9    10   447 mod.max       449.   461.   2.33   1538.  1543.
## 10    10   447 samp.max      408.   419  -38.5    1271.  2755.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
