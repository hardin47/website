...
## 1 151.00     158      121  133.10         122     146.6667    10  147
## 2 150.12     150      147  148.47         148     148.9495   100  147
## 3 368.80     313      432  475.20         467     485.2222    10  447
## 4 487.50     516      447  451.47         450     452.9697   100  447
## 5 175.20     211      131  144.10         151     135.6667    10  147
## 6 145.88     144      147  148.47         148     148.9495   100  147
## 7 336.60     278      426  468.60         441     502.3333    10  447
## 8 456.52     468      446  450.46         448     452.9697   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            154.
##  2    10   147 median2          151 
##  3    10   147 samp.max         141 
##  4    10   147 mod.max          155.
##  5    10   147 sum.min.max      161 
##  6    10   147 diff.min.max     148.
##  7   100   147 xbar2            156.
...
##  1    10   147 diff.min.max  148.   152.   0.934    363.   364.
##  2    10   147 median2       146.   147   -0.532   1602.  1602.
##  3    10   147 mod.max       148.   152.   1.37     159.   161.
##  4    10   147 samp.max      135.   138  -12.1      132.   278.
##  5    10   147 sum.min.max   149.   148    1.73     299.   302.
##  6    10   147 xbar2         147.   147.  -0.0814   704.   704.
##  7    10   447 diff.min.max  443.   452.  -4.02    3841.  3857.
##  8    10   447 median2       452.   452.   5.27   14726. 14754.
##  9    10   447 mod.max       447.   459.   0.0697  1594.  1594.
## 10    10   447 samp.max      406.   417  -40.6     1317.  2963.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
