...
## 1 196.20     255      147  161.70         151     174.7778    10  147
## 2 147.84     143      147  148.47         148     148.9495   100  147
## 3 558.20     592      444  488.40         494     481.5556    10  447
## 4 467.26     445      447  451.47         457     445.8283   100  447
## 5 202.20     236      147  161.70         160     163.7778    10  147
## 6 156.76     166      147  148.47         148     148.9495   100  147
## 7 281.80     289      288  316.80         290     349.5556    10  447
## 8 449.32     449      447  451.47         448     455.0101   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            185 
##  2    10   147 median2          216 
##  3    10   147 samp.max         146 
##  4    10   147 mod.max          161.
##  5    10   147 sum.min.max      176 
##  6    10   147 diff.min.max     142.
##  7   100   147 xbar2            150.
...
##  1    10   147 diff.min.max  148.   152.   0.902   379.   380.
##  2    10   147 median2       145.   146.  -1.93   1513.  1516.
##  3    10   147 mod.max       148.   152.   1.00    164.   165.
##  4    10   147 samp.max      135.   138  -12.5     135.   290.
##  5    10   147 sum.min.max   148.   148    1.08    306.   307.
##  6    10   147 xbar2         146.   146.  -0.895   643.   643.
##  7    10   447 diff.min.max  449.   460.   2.20   3624.  3629.
##  8    10   447 median2       448.   445    0.582 15638. 15638.
##  9    10   447 mod.max       450.   462    2.76   1635.  1643.
## 10    10   447 samp.max      409.   420  -38.1    1352.  2805.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
