...
## 1 125.60     113      134  147.40         148     146.6667    10  147
## 2 145.12     146      147  148.47         148     148.9495   100  147
## 3 420.20     351      408  448.80         436     464.4444    10  447
## 4 407.66     387      441  445.41         446     444.8081   100  447
## 5 157.20     177      128  140.80         131     152.7778    10  147
## 6 142.06     138      147  148.47         148     148.9495   100  147
## 7 426.20     395      432  475.20         456     498.6667    10  447
## 8 481.38     497      447  451.47         449     453.9899   100  447
```
...
##    <dbl> <dbl> <chr>           <dbl>
##  1    10   147 xbar2            146.
##  2    10   147 median2          168 
##  3    10   147 samp.max         129 
##  4    10   147 mod.max          142.
##  5    10   147 sum.min.max      130 
##  6    10   147 diff.min.max     156.
##  7   100   147 xbar2            147.
##  8   100   147 median2          146 
...
##  1    10   147 diff.min.max  148.   152.   1.31    357.   358.
##  2    10   147 median2       147.   148    0.481  1578.  1579.
##  3    10   147 mod.max       148.   152.   0.936   161.   162.
##  4    10   147 samp.max      134.   138  -12.5     133.   289.
##  5    10   147 sum.min.max   148.   148    0.627   292.   292.
##  6    10   147 xbar2         147.   147   -0.450   655.   655.
##  7    10   447 diff.min.max  451.   462    3.82   3505.  3519.
##  8    10   447 median2       441.   436.  -6.05  16742. 16779.
##  9    10   447 mod.max       449.   461.   1.86   1621.  1624.
## 10    10   447 samp.max      408.   419  -38.9    1340.  2857.
## # … with 14 more rows
## # ℹ Use `print(n = ...)` to see more rows
```
