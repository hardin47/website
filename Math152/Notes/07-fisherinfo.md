...
::: {.example}
Back to the example, $N(\theta,\theta)$.  We found that one estimator is: $r(\underline{x}) = \frac{-1 + \sqrt{1+4 \frac{\sum x_i^2}{n}}}{2}$.    And $I(\theta) = \frac{(1+2\theta)}{2 \theta^2}$.
...
::: {.example}
Back to the example, $N(\theta,\theta)$.  We found that one estimator is: $\hat{\theta} = \frac{-1 + \sqrt{1+4 \frac{\sum x_i^2}{n}}}{2}$.    And $I(\theta) = \frac{(1+2\theta)}{2 \theta^2}$.
