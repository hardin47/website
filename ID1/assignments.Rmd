...
Please be sure to read Pomona’s Policies on Academic Integrity: http://catalog.pomona.edu/content.php?catoid=7&navoid=394. [Additional information](../ID1/Academic_Integrity.doc) on citation, summarizing, and working with others so that you can successfully maintain academic integrity. You will be held to all these standards from this day forward.


## Micro-essays  (fewer than 500 words)

You may want to look at the [peer review](../ID1/ID1 micro peer.pdf) guidelines used to provide feedback on your written work.
...
9/16/2018  
Believing / Doubting game.  Reading Borges with and against the grain ([see handout](../ID1/ID1 withagainst.pdf)).  Paper is due to Sakai by Sunday midnight.  In Word, double spaced, put your name inside the Word document, no title necessary.
...
You may be curious about the [grading rubric](../ID1/grading rubric.pdf) for the formal papers.


#### Paper 1  
Due: 9/20/2018, 9/25/2018, 10/1/2018, 10/12/2018  
[Paper 1](../ID1/ID1 Essay1.pdf)  

Thoughts on [writing with a lens text](../ID1/lens.pdf)

[Peer Review for Paper 1 before class](../ID1/ID1 Essay1 peer.pdf)  
[Peer Review for Paper 1 in class](../ID1/ID1 Essay1 peer inclass.pdf)  


#### Paper 2  
Due: 10/16/2018, 10/23/2018, 11/4/2018  
[Paper 2](../ID1/ID1 Essay2.pdf)  
[Peer Review for Paper 2 before class](../ID1/ID1 Essay2 peer.pdf)  
[Peer Review for Paper 2 in class](../ID1/ID1 Essay2 peer inclass.pdf)  


#### Paper 3  
Due: 11/16/2018, 11/25/2018, 12/2/2018, 12/9/2018  
[Paper 3](../ID1/ID1 Essay3.pdf)  

Your final paper will center around a research question (that will become a thesis statement) which will be argued using sources that you find.  The research question will continue to evolve over the life of the project, but you should keep coming back to the (evolving) idea you want to argue.   In addition to a **succinct and arguable thesis statement**, your paper should include:

1. Thesis statement somewhere early on and clear to your reader.
2. Details of the event of interest.
3. Historical context ({\it why} the thing you describe happened / was able to happen).   
...
5. A potential audience for your paper is a STEM undergraduate who feels disempowered by the traditional canon.   If your paper speaks to a different audience, please talk to me before turning in your assignments.

##### Ideas for getting started include: {-}



* Some of the founders of the discipline of statistics were eugenicists.
...
[handout on annotated bibliographies](../ID1/ID1 annotated bib.pdf) 

[handout on citing sources](../ID1/ID1 citing.pdf)  (Link to the   [solutions](https://www.kean.edu/~library/handouts/Answer_Guide_Citing_Sources_Avoiding_Plagiarism_Scenarios.pdf).)    

The worksheet was taken directly from the [Kean University Library](http://libguides.kean.edu/Library); [original source](https://www.kean.edu/~library/handouts/Citing_Sources_Avoiding_Plagiarism_Scenarios.pdf).
