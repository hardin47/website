...
(We won't cover Fisher's Exact Test, but it is pretty cool! Using combinatorics, the exact p-value can be computed directly without doing repeated simulations.)
