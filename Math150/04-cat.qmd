...
[http://www.rossmanchance.com/applets/2021/chisqshuffle/ChiSqShuffle.htm](http://www.rossmanchance.com/applets/2021/chisqshuffle/ChiSqShuffle.htm)
...
(Section 6.4 in @KuiperSklar, great detailed explanation! We won't cover Fisher's Exact Test, but it is pretty cool! Using combinatorics, the exact p-value can be computed directly without doing repeated simulations.)
...
\begin{eqnarray*}
15/58=0.2586 & \ \ \ 6/58 = 0.103 &  \Delta = 0.156\\
p_1 = 0.65 & \ \ \ p_2 = 0.494 & \Delta = 0.156\\
p_1 = 0.157 & \ \ \ p_2 = 0.001 &  \Delta = 0.156\\
\end{eqnarray*}
:::
...
\mbox{OR} &= \frac{\theta_1}{\theta_2} = \frac{p_1/(1-p_1)}{p_2/(1-p_2)}\\
...
Disadvantages from: [http://sphweb.bumc.bu.edu/otlt/MPH-Modules/EP/EP713_CohortStudies/EP713_CohortStudies5.html](http://sphweb.bumc.bu.edu/otlt/MPH-Modules/EP/EP713_CohortStudies/EP713_CohortStudies5.html)
...
(This is the simulation we did in class with the playing cards, the part we didn't cover is the exact calculation using combinatorics.)
...
We didn't cover the exact calculation of the p-value for Fisher's Exact Test, but we did cover CI for the OR.
However, the <a href = "https://stats.stackexchange.com/questions/409219/how-does-fisher-test-calculate-the-confidence-interval-for-the-odds-ratio-in-r" target = "_blank">method used</a> in `fisher.test()` to compute the CI is outside the scope of this class.
