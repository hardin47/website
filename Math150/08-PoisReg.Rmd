...
```{r out.width = "90%", fig.cap = "Visualizing Normal vs Poisson Error Regression from @bysh."}
...
```{r out.width = "90%", fig.cap = "Differences in Normal vs Poisson Error Regression from @bysh."}
