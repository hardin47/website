...
head(surgery)  |>
  ...
  kableExtra::kable(caption = "Varibles associated with the surgery data.") |>
...
```{r fig.cap = "Figure taken from [@iscam]",  out.width="95%", fig.align='center', echo=FALSE}
knitr::include_graphics("figs/randsampValloc.jpg")
```
