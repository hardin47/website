...
#par(mfrow=c(2,2))
hist(t0.pvals, main="H0: mu = 47, HA: mu = 47", xlim=c(0,1))
mtext("p-values under H0 and Ha conditions for 500 indep tests", side=3, line=-1.2, outer=T, cex = 1.7)
hist(t1.pvals, main="H0: mu = 40, HA: mu = 47", xlim=c(0,1))
hist(t2.pvals, main="H0: mu = 48, HA: mu = 47", xlim=c(0,1))
hist(t3.pvals, main="H0: mu = 50, HA: mu = 47", xlim=c(0,1))
```
...
```{r echo=FALSE, fig.cap = "Varying the proportion of null genes and the value of the parameter being tested in the null hypothesis. The null hypothesis varies, with the alternative set at HA: mu = 47.", fig.show = 'hold', out.width='47%', fig.ncol = 2}
