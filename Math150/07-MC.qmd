...
```{r}
#| fig-cap: "Different $\\alpha^*$ values for three different stopping criteria. Note that Peto does not control the test at an overall $\\alpha=0.05,$ although it is close."
#| fig-width: 8
#| fig-align: 'center'
#| echo: false
