...
# let g = proporiton of null genes
...
df_tests_stop %>%
  ...
  ggtitle("Raw p-value reject: Type 1 ~ 12%")
```
...
df_tests_stop %>%
  ...
  scale_color_viridis_d(begin = .9, end = .1) +
  ggtitle("Bonferroni p-value reject: Type 1 ~ 3%")
...
df_tests_stop %>%
  ...
  scale_color_viridis_d(begin = .9, end = .1) +
  ggtitle("Pocock p-value reject: Type 1 ~ 5%")
...
df_tests_stop %>%
  ...
  scale_color_viridis_d(begin = .9, end = .1) +
  ggtitle("Peto p-value reject: Type 1 ~ 5%")
```
...
df_tests_stop %>%
  ...
  scale_color_viridis_d(begin = .9, end = .1) +
  ggtitle("O'Brien-Fleming p-value reject: Type 1 ~ 5%")
