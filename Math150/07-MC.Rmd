...
Sometimes the interim criterial are referred to as "alpha spending" because the total type I error rate (that is, rejecting the original claim at any of the interim analysis steps if $H_0$ is true) should be $\alpha$, but the $\alpha$ probability of a type I error should be spread over the interim tests. 
