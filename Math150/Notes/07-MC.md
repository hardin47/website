...
<div class="figure" style="text-align: center">
<img src="figs/alphaInterim.png" alt="Different $\alpha^*$ values for three different stopping criteria. Note that Peto does not control the test at an overall $\alpha=0.05,$ although it is close." width="80%" />
<p class="caption">(\#fig:unnamed-chunk-4)Different $\alpha^*$ values for three different stopping criteria. Note that Peto does not control the test at an overall $\alpha=0.05,$ although it is close.</p>
</div>
