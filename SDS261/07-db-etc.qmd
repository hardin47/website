# Other fun database snippets {#sec-db-etc}
...
back to flights.  see: https://mdsr-book.github.io/mdsr3e/16-sqlII.html#query-plans

full example: https://mdsr-book.github.io/mdsr3e/16-sqlII.html#sec-toy-db
