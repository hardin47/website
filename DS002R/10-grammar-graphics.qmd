...
For additing alt text see: <a href = "https://www.apreshill.com/blog/2022-04-we-dont-talk-about-quarto/#what-youll-like" target = "_blank">how to add alt text</a>. Feel free to use (and then check!!!) the <a href = "https://numbats.github.io/autoAlt/index.html" target = _blank">`autoAlt` package</a> in R which automatically generates alt text.
...
* Did you add alt text to your images? See <a href = "https://medium.com/nightingale/writing-alt-text-for-data-visualization-2a218ef43f81" target = "_blank">Writing Alt Text for Data Visualizations</a> and <a href = "https://www.apreshill.com/blog/2022-04-we-dont-talk-about-quarto/#what-youll-like" target = "_blank">how to add alt text</a>. Feel free to use (and then check!!!) the <a href = "https://numbats.github.io/autoAlt/index.html" target = _blank">`autoAlt` package</a> in R which automatically generates alt text.

* Is your plot accessible to those who are color blind or looking at the image in black and white? Hint: use color-vision-safe palettes like <a href = "https://ggplot2.tidyverse.org/reference/scale_viridis.html" target = "_blank">`viridis`</a> or < href = "https://malcolmbarrett.github.io/ggokabeito/" target = "_blank">`Okabe–Ito`</a>.
