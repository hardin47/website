...
There are three ways to engage with SQL using R.  We will discuss each of them in this chapter, and we will expand on the third method in what follows (using interfaces like DBeaver or Quarto to run actual SQL code directly).
...
@sec-sql-clauses will explore more **SQL** queries and using **SQL** keywords. For now, let's continue learning about the different ways **R** can talk to **SQL**.
...
1. What are the three main ways to write a **SQL** query using the **Quarto** interface?
