...
* What are the pieces of a reproducible example?

* What are the common things that you might forget to provide to your collaborator when sending them a reproducible example?


## <i class="fas fa-balance-scale"></i> Ethics considerations 

* Why is it important to be able to condense the question into a reproducible example?

* What might happen in the process of creating a reproducible example?^[You might solve your own problem!]
