...
> Great resource:  The Positron **Shiny** cheatsheet: https://opensource.posit.co/resources/cheatsheets/shiny/
...
* If you're not using Positron, you can (`source()`) the whole document, or call `shiny::runApp()` with the path to the directory containing `app.R`.
:::
