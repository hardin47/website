...
```{r echo = FALSE}
library(GGally)
ggpairs(data.frame(amount, num.coins, num.lowcoins), lower = list(continuous = GGally::wrap("points", size = 0.1))) + 
...
```{r echo = FALSE, eval = FALSE}
(Example taken from American Statistician article that I refereed, August 2012.)
```
