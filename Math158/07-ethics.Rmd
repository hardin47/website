...
image_write(img1_with_border, "figs/img1_with_border.png")
image_write(img2_with_border, "figs/img2_with_border.png")
image_write(img3_with_border, "figs/img3_with_border.png")
image_write(img4_with_border, "figs/img4_with_border.png")
```
...
knitr::include_graphics("figs/GAcovid.jpg")
```
...
knitr::include_graphics("figs/GAcovid2.jpg")
```
...
```{r fig.cap = "July 2, 2020 (left) and July 17, 2020 (right), Georgia Department of Health, COVID-19 cases per 100K https://dph.georgia.gov/covid-19-daily-status-report", out.width='42%', fig.align='center', echo=FALSE, fig.show = 'hold'}
knitr::include_graphics(c("figs/img3_with_border.png","figs/img4_with_border.png"))
```
...
```{r fig.cap = "From the  Kent County COVID dashboard, screen shot 8/25/2021.  https://www.accesskent.com/Health/covid-19-data.htm", out.width='90%', fig.align='center', echo=FALSE, fig.alt = "Screen shot of the Kent, MI COVID dashboard.  There are three peaks over the last year and a half (Dec 2021, April 2021, and August 2021).  The peaked data should not be modeled with a linear trend."}
knitr::include_graphics("figs/COVIDkentMI.png")
```


## p-hacking

* Great applet from 538 on how to get significance by trying many things: https://projects.fivethirtyeight.com/p-hacking/
...
* Many people think CIs are far superior to p-values.  Not only can you assess significance, but you can also assess effect size.  Here is a video that compares p-values and confidence intervals:
...
* Many people think CIs are far superior to p-values.  Not only can you assess significance, but you can also assess effect size.  Here is a video that compares p-values and confidence intervals; it also addresses how p-values can be misinterpreted.  The Dance of the P-values (think about power when you watch it): https://www.youtube.com/watch?v=5OL1RqHrZQ8
