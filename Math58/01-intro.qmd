...
```{r randSleuth, fig.cap = "Random Sample vs Randomized Experiment, taken from @sleuth", out.width="95%", fig.align='center', echo=FALSE}
knitr::include_graphics("figs/randsampexp.png")
```

```{r randgoodQ, fig.cap = "Random Sample vs Randomized Experiment, taken from https://askgoodquestions.blog/", out.width = "95%", fig.align='center', echo=FALSE}
