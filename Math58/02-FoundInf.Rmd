...
visualize(null_YT_right) +
  ggtitle("Simulation Distribution of p-hat, when p=0.47") +
  xlab("possible values of the sample proportion")
```
...
# visualize the null sampling distribution
visualize(bs_YT_right) +
  ggtitle("Bootstrap Distribution when p-hat = 0.29") +
  xlab("possible values of the bootstrapped proportions")
```
