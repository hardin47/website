...
> The authors write of a "significantly higher risk" (discernibly higher risk) for blood group A but, as one reader pointed out in the comments section, this does not mean that the risk is greatly higher; it means that a p-value was small. Notice that the CI for the odds ratio is above 1, but it comes close to 1 and is centered a 1.20 and not, say, 2.5.
> "Meta-analyses on the pooled data showed that blood group A had a significantly higher risk (discernibly higher risk) for COVID-19 (odds ratio-OR, 1.20; 95% confidence interval-CI [1.02,1.43], P = 0.02) compared with non-A blood groups."
